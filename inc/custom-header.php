 ...
 * @uses _skele_admin_header_image()
 *
...
function _skele_custom_header_setup() {
    $args = array(
        ...
        'flex-height'            => false,
        'flex-width'            => false,
        'wp-head-callback'       => '_skele_header_style',
        'admin-head-callback'    => '_skele_admin_style',
        'admin-preview-callback' => '_skele_admin_header_image',
    );

    $args = apply_filters( '_skele_custom_header_args', $args );
...
if ( ! function_exists( '_skele_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see _skele_custom_header_setup().
 *
...
endif; // _skele_header_style

if ( ! function_exists( '_skele_admin_style' ) ) :
/**
...
endif; // _skele_admin_style

if ( ! function_exists( '_skele_admin_header_image' ) ) :
/**
...
<?php }
endif; // _skele_admin_header_image
